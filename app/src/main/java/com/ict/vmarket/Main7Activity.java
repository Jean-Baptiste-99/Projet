...
public class Main7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Lv = findViewById(R.id.RecyclerPop_samsu_p);
        Lv2 = findViewById(R.id.RecyclerPop_samsu_promo);
        mproduitlist = new ArrayList<>();
        mproduitlist2 = new ArrayList<>();
        dialog = new ProgressDialog(Main7Activity.this);
    ...
    private void parseJSON() {
        String url = "http://market.paytickettogo.com/vmarket/samsung.php";
        ...
        requestQueue = Volley.newRequestQueue(Main7Activity.this);
    ...
    private void stuprecyclerview(List<ProduitItem> mproduitlist) {
        ...
        ProduitAdapter adapter = new ProduitAdapter(Main7Activity.this, mproduitlist);
        Lv.setLayoutManager(new LinearLayoutManager(Main7Activity.this, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void parseJSON2() {
        String url = "http://market.paytickettogo.com/vmarket/samsung2.php";
        JsonArrayRequest request = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
    ...
    private void stuprecyclerview2(List<ProduitItem> mproduitlist) {
        ...
        PromoAdapter adapter = new PromoAdapter(Main7Activity.this, mproduitlist);
        Lv2.setLayoutManager(new LinearLayoutManager(Main7Activity.this, LinearLayoutManager.HORIZONTAL, false));
