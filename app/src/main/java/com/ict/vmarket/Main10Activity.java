...
public class Main10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Lv = findViewById(R.id.RecyclerPop_xiaomi_p);
        Lv2 = findViewById(R.id.RecyclerPop_xiaomi_promo);
        mproduitlist = new ArrayList<>();
        mproduitlist2 = new ArrayList<>();
        dialog = new ProgressDialog(Main10Activity.this);
    ...
    private void parseJSON() {
        String url = "http://market.paytickettogo.com/vmarket/xia.php";
        ...
        requestQueue = Volley.newRequestQueue(Main10Activity.this);
    ...
    private void stuprecyclerview(List<ProduitItem> mproduitlist) {
        ...
        ProduitAdapter adapter = new ProduitAdapter(Main10Activity.this, mproduitlist);
        Lv.setLayoutManager(new LinearLayoutManager(Main10Activity.this, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void parseJSON2() {
        String url = "http://market.paytickettogo.com/vmarket/xia2.php";
        JsonArrayRequest request = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
    ...
    private void stuprecyclerview2(List<ProduitItem> mproduitlist) {
        ...
        PromoAdapter adapter = new PromoAdapter(Main10Activity.this, mproduitlist);
        Lv2.setLayoutManager(new LinearLayoutManager(Main10Activity.this, LinearLayoutManager.HORIZONTAL, false));
