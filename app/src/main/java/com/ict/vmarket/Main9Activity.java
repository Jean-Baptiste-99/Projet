...
public class Main9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Lv = findViewById(R.id.RecyclerPop_ug_p);
        Lv2 = findViewById(R.id.RecyclerPop_ug_promo);
        mproduitlist = new ArrayList<>();
        mproduitlist2 = new ArrayList<>();
        dialog = new ProgressDialog(Main9Activity.this);
    ...
    private void parseJSON() {
        String url = "http://market.paytickettogo.com/vmarket/ug.php";
        ...
        requestQueue = Volley.newRequestQueue(Main9Activity.this);
    ...
    private void stuprecyclerview(List<ProduitItem> mproduitlist) {
        ...
        ProduitAdapter adapter = new ProduitAdapter(Main9Activity.this, mproduitlist);
        Lv.setLayoutManager(new LinearLayoutManager(Main9Activity.this, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void parseJSON2() {
        String url = "http://market.paytickettogo.com/vmarket/ug2.php";
        JsonArrayRequest request = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
    ...
    private void stuprecyclerview2(List<ProduitItem> mproduitlist) {
        ...
        PromoAdapter adapter = new PromoAdapter(Main9Activity.this, mproduitlist);
        Lv2.setLayoutManager(new LinearLayoutManager(Main9Activity.this, LinearLayoutManager.HORIZONTAL, false));
