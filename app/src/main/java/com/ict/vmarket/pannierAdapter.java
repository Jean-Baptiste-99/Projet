...
public class pannierAdapter extends BaseAdapter {
    ...
    private ArrayList<pannier> pannierlist;
    private int layout;
    ...
    public pannierAdapter(Context context, ArrayList<pannier> pannierlist, int layout) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row==null){
            ...
            holder.t1 = (TextView) row.findViewById(R.id.product_name_pan_card);
            holder.t2 = (TextView) row.findViewById(R.id.prix_pan_card);
            holder.t3 = (TextView) row.findViewById(R.id.product_qt_pan_card);
            holder.t4 = (TextView) row.findViewById(R.id.product_id_card);
            holder.t5 = (TextView) row.findViewById(R.id.click_ent_cart);
            holder.b1 = (Button) row.findViewById(R.id.btn_reserv_p);
            holder.imageView = (ImageView) row.findViewById(R.id.product_image_pan_card);
            holder.i1 = (ImageButton) row.findViewById(R.id.pannier_del_cart);
            holder.leading = (ProgressBar) row.findViewById(R.id.progressBar2_p);
            row.setTag(holder);
                                           ...
                                           // ti2.getEditText().setText("");
                                            ...
                                            alert.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialog, int i) {
                                                    ...
                                                    String url = "http://192.168.43.189:8080/VMarketphp/Reserver.php";
                                                    ...
                                                    StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                                                        ...
                                                        protected Map<String, String> getParams() {
                                                            ...
                                                            String id = finalHolder.t4.getText().toString().trim();
                                                            String img = finalHolder.imageView.toString().trim();
                                                            String ent = finalHolder.t5.getText().toString().trim();
        ...
        pannier p = pannierlist.get(position);
        ...
        holder.t4.setText(p.getProduct_id());
        holder.t5.setText(p.getProduct_ent());
